...
# BASE1 = "http://127.0.0.1:5001/"
# BASE2 = "http://127.0.0.1:5002/"
# BASE3 = "http://127.0.0.1:5003/"
...
# sio = socketio.Client()
# sio.connect(BASE3, namespaces=['/communication'])
...
#     }
#     response = requests.post(BASE2+'rating', driver_rating)
#     print(response.json())
...
response = requests.post('http://localhost:5005/rating',{"_id": 1009,
        "name": "ibrahim",
        "rating": 4})
print(response.json())